...
const tutorialSteps = [
    ...
    /*1.1*/"1.1<br><br> In the background you may see the default <span style='color:red'>Band Heater</span>.<br><br> Click and drag <span style='color:red'>Left</span> mouse button to rotate the band.<br><br> Click and drag the <span style='color:red'>Right</span> mouse button to move the band around <br><br> Press <span style='color:red'>'o'</span> or press <span style='color:red'>View>Reset Camera</span> to go back to default front perspective",
