...
const tutorialStepsEN = [
    ...
    /*2*/"2<br><br> In the background you may see the default <span style='color:red'>Plate Heater</span>.<br><br> Click and drag <span style='color:red'>Left</span> mouse button to rotate the plate.<br><br> Click and drag the <span style='color:red'>Right</span> mouse button to move the plate around <br><br>Zoom in and out with your <span style='color:red'>MouseWheel</span><br><br> Press <span style='color:red'>'o'</span> or go to <span style='color:red'>View>Reset Camera</span> to reset to default 2D perspective",
    ...
    /*4*/"4<br><br> Open the <span style='color:blue'>Plate Size</span> window.<br><br> Here you can set the <span style='color:red'>Width</span> and <span style='color:red'>Diameter</span> of the plate. You may lower the <span style='color:red'>Resolution</span> if experiencing lag. The resolution affects the plate and hole detail. Recommended value = 1000<br><br> Click <span style='color:red'>Submit</span> to apply the changes ",
    ...
    /*7*/"7<br><br> Open the <span style='color:blue'>Planner</span><br><br> The planner is where you will be able to customise <span style='color:red'>Terminals</span> and <span style='color:red'>Holes</span> on your plate <br><br> The planner flattens out the plate on a long rectangle, at the bottom of the planner you may notice x° marks that indicates where you are on the plate. <br><br> Move around the plate by using the <span style='color:red'>Horizontal Sidebar</span> at the bottom or by using your <span style='color:red'>MouseWheel</span><br><br> Note: 0 is on the left and the end of the plate is on the right ",
    ...
    /*9*/"9<br><br> Click on the new added Circular white hole.<br><br> You can <span style='color:red'>move</span> it around by dragging its center and <span style='color:red'>resize</span> it  by dragging the edge. <br><br> Next open the <span style='color:blue'>Component</span> menu. <br><br>In this menu, you may manually enter the <span style='color:red'>Position</span>, <span style='color:red'>Offset</span>, <span style='color:red'>Height</span> and <span style='color:red'>Width</span>.<br><br> Press 'Enter' to apply the changes<br><br>Note: Changes can only be done if the hole is selected, <span style='color:red'>Position</span> indicates the position of the component horizontaly, <span style='color:red'>Offset</span> sets the Vertical position using the distance from the top (edge of the plate) to the center of the component",
   ...
   /*13*/"13<br><br> Open the <span style='color:blue'>Additional notes</span> menu. <br><br> Here you may enter any additional specifications for your item.",
    ...
    /**/"Exercise 1<br><br> Make the following plate: <br><br> Width: 3in<br>Diameter:10in<br>Power: 500W<br>Voltage: 120V<br>2 Sections equally sized with QuickLatch closing and 0.38in gap length<br>1 Bornier at 30° 1inch offset<br>1 Bornier at 30° 2inch offset<br> One 1.2inch diameter hole at 60° 1.5inch offset <br> One mirrored copy of the first hole<br><br> Write down in the notes the total current draw,  the total power density and your name<br><br> Submit your project",
]
const tutorialSteps = [
    ...
    /*2*/"2<br><br> Dans le fond d'écran, vous pouvez observez une <span style='color:red'>Plaque Chauffante</span>.<br><br> Clickez et glissez le bouton <span style='color:red'>Gauche</span> de la souris pour faire tourner la plaque.<br><br> Pesez et glisser le bouton <span style='color:red'>Droit</span> de la souris pour faire bouger la plaque <br><br>Aggrandissez l'image avec <span style='color:red'>la roulette</span> de la souris.<br><br> Pesez <span style='color:red'>'o'</span> ou allez à <span style='color:red'>Vue>Reset Caméra</span> pour revenir à la perspective de départ",
    ...
    /*4*/"4<br><br> Ouvrez la fenêtre <span style='color:blue'>Dim. Plaque</span>.<br><br> Ici vous pouvez ajuster l'attribut <span style='color:red'>Largeur</span> et <span style='color:red'>Diamètre</span> de la plaque. Si vous avez des problèmes de performance, vous pouvez réduire l'attribut <span style='color:red'>Résolution</span>. La résolution affecte le détail de la plaque. Valeur recommendée = 1000<br><br> Clickez <span style='color:red'>Submit</span> pour appliquer les changements.",
    ...
    /*7*/"7<br><br> Ouvrez la fenêtre <span style='color:blue'>Planner</span><br><br> Le planner est l'endroit où vous pourrez personaliser les <span style='color:red'>Terminals</span> et les <span style='color:red'>Trous</span> sur votre plaque.<br><br> Le planner montre la plaque sur un long rectangle. out the band on a long rectangle. Au bas du planner, vous pouvez y trouver des marques x'' qui indique où vous vous situez sur la plaque. <br><br> Déplacez vous sur la plaque en utilisant la <span style='color:red'>Barre horizontale</span> au bas de la fenêtre ou en utilisant la <span style='color:red'>Roulette de souris</span><br><br> Note: 0° à la gauche et 360° est à la droite",
   ...
   /*13*/"13<br><br> Ouvrez la fenêtre <span style='color:blue'>Additional notes</span>. <br><br> Ici vous pouvez ajouter toutes les spécification et notes manquantes pour votre item.",
    /**/"Last<br><br> Lorsque vous aurez terminé votre item, clickez sur <span style='color:red'>Submit Project</span> pour aller au menu de soumission et pour démarrer l'envoie de votre demande<br><br> Allez à <span style='color:red'>Edit>Pratique</span> pour démarrer un exemple.",
