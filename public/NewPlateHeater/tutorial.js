...
const tutorialSteps = [
   ...
   /*11*/"11<br><br> <span style='color:red'>IMPORTANT</span>:<br><br> All changes made in the planner wont be applied unless you press '<span style='color:red'>Save</span>'in the toolbar<br><br> You can only modify a terminal or hole if it is <span style='color:red'>Selected</span><br><br> CLOSE the planner to look at the modified plate",
